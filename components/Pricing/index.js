...
export default function Pricing(){
    return(
        ...
        <h2 className='font-semibold text-[var(--highlight)] text-xl mb-2'>Pricing</h2>
        <h1 className='text-4xl font-semibold text-center mb-4'>Perfect plans for your needs.</h1>
